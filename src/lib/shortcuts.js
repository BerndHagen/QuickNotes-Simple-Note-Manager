...
export const DEFAULT_SHORTCUTS = {
  ...
  zoomIn: { key: '=', ctrl: true, owner: 'workspace', description: 'Zoom in workspace (or Ctrl + mouse wheel up)' },
  zoomOut: { key: '-', ctrl: true, owner: 'workspace', description: 'Zoom out workspace (or Ctrl + mouse wheel down)' },
  zoomReset: { key: '0', ctrl: true, owner: 'workspace', description: 'Reset workspace zoom' },
