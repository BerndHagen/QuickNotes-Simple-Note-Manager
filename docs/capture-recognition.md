...
Task 4 adds attributable recognition to the existing QuickNotes content engines. Notes, Paper/Canvas objects, PDF files, images, and recordings remain canonical. Recognition never replaces the source.
...
- Current recognition enters the Task 3 lexical index. Search locations return to the selected spatial object, PDF page, or audio timestamp.
