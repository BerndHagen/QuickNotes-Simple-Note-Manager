    ...
    <div className="qn-modal-viewport fixed inset-0 z-dialog flex items-end justify-center sm:items-center sm:p-4">
      ...
      >
        ...
        {(title || !hideCloseButton) && (
          <header className="flex shrink-0 items-start gap-3 border-b border-subtle px-5 py-4 sm:px-6">
            {Icon && (
              <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-control bg-accent-soft text-accent-text">
