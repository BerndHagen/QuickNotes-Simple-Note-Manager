              ...
              {sharedNotes.length === 0 ? (
                ...
                sharedNotes.map((share) => {
                  ...
                  return (
                    <div
                      key={share.id}
                      className="p-4 border dark:border-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors"
                    >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 text-sm">
                            <span className="px-2 py-0.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded border dark:border-gray-600">
